...
class SigWeb2 extends StatefulWidget {
  const SigWeb2({super.key, required this.title});

  final String title;

  @override
  State<SigWeb2> createState() => _SigWebState();
}

class _SigWebState extends State<SigWeb2> {
          ...
          for (var line in feature['geometry']['coordinates']) {
            ...
            newPolylines.add(
              Polyline(
                polylineId: polylineId,
                points: linePoints,
                color: Color.fromARGB(255, 83, 83, 81), // Default color for MultiLineString
                width: 3,
              ),
            );
          }
